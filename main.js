...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (class {
    static #todoList = (0,_storage__WEBPACK_IMPORTED_MODULE_0__.getItem)("todoList") || {};
            ...
            if (!this.#todoList.hasOwnProperty(projectID)) {
                ...
                while (true) {
                    ...
                    if (!this.#projectAlreadyExists(newProjectName)) {
                        ...
                        (0,_storage__WEBPACK_IMPORTED_MODULE_0__.setItem)("todoList", this.#todoList);
    ...
    function loadTasks(tasksObject, message) {
        ...
        for (const projectID in tasksObject) {
            for (const taskID in tasksObject[projectID]) {
                ...
                let projectName = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectName(projectID);
                    ...
                    <div class="task ${priority} ${completed? "checked":""}" data-project-id="${projectID}" data-task-id="${taskID}">
                        ...
                        <div class="panel">
                            ...
                            <div class="details">
                                ...
                                <div class="due-date">
                                    <h5>Due date:</h5>
                                    <div>${date? (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(date), "PPPP"):"N/A"}</div>
                                </div>
                                <div class="priority">
                                    <h5>Priority:</h5>
...
const task = (function () {
    ...
    function check(element) {
        ...
        _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].checkTask(element.dataset.projectId, element.dataset.taskId, checkboxValue);
    }
    ...
    function edit(element) {
        ...
        const thisTask = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getTask(element.dataset.projectId, element.dataset.taskId);
        ...
        // Makes task uneditable.
            ...
            const date = thisTask.date? (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(thisTask.date), "PPPP"):"N/A";
    ...
    function save(element) {
        ...
        if (title && _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].editTask(title, description, date, priority, element.dataset.projectId, element.dataset.taskId)) {
            edit(element);
    ...
    function remove(element) {
        _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].deleteTask(element.dataset.projectId, element.dataset.taskId);
...
const addTaskButton = (function () {
    function addNewTask(projectID) {
        const taskID = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].createTask(projectID);

        // Checks if number of tasks didn't exceed 10.
        if (taskID !== -1) {
            const tasksObject = {};
            tasksObject[projectID] = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getTasks(projectID);

            tasks.loadTasks(tasksObject, _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectName(projectID));
...
const projects = (function () {
    ...
    function loadProjects() {
        ...
        const allProjects = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects();
...
const project = (function () {
    ...
    function edit(element) {
        ...
        const thisProject = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectName(element.dataset.id);
    ...
    function save(element) {
        ...
        if (name && _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].editProject(element.dataset.id, name)) {
            // Load tasks of saved project if it is selected.
            if (navigation.getSelectedProject() === element.dataset.id) {
                const tasksObject = {};
                tasksObject[element.dataset.id] = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getTasks(element.dataset.id);
    ...
    // Removes project.
    function remove(element) {
        _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].deleteProject(element.dataset.id);
...
const addProjectButton = (function () {
    function addNewProject() {
        const projectID = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].createProject();
...
const navigation = (function () {
    ...
    function getTasksByDate(dateFunction) {
        ...
        for (const projectID in allProjects) {
            let allTasks = _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getTasks(projectID);
    ...
    function loadTasksOfProject(element) {
        ...
        tasks.loadTasks(tasksObject, _todo_list__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectName(element.dataset.id));
    }
    ...
    function loadToday() {
        ...
        const tasksObject = getTasksByDate(date_fns__WEBPACK_IMPORTED_MODULE_2__["default"]);
    ...
    function loadThisWeek() {
        ...
        const tasksObject = getTasksByDate(date_fns__WEBPACK_IMPORTED_MODULE_3__["default"]);
